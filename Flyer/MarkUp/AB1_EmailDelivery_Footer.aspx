<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AB1_EmailDelivery_Footer.aspx.cs" Inherits="FlyerMe.Flyer.MarkUp.AB1_EmailDelivery_Footer" MasterPageFile="" Theme="" ValidateRequest="false" %>
	...
	<tr>
    	<td align="center">
        	<table width="648" cellpadding="0" cellspacing="26" border="0" bgcolor="#f4f4f4" style="font-family:Verdana, sans-serif; font-size:14px; line-height:22px">
                ...
                <tr>
                    <td>
                        <img src="<%= RootUrl %>webbeacons.aspx?orderid=<%= OrderId %>&subscriberid=<%= SubscriberId %>" />
                        <img src="<%= RootUrl %>webdummy.aspx?order_id=<%= OrderId %>&subscriber_id=<%= SubscriberId %>&unsubscribe_key=<%= UnsubscribeKey %>&subscriberemailid=<%= SubscriberEmailId %>">
                    </td>
                </tr>
            </table>
        </td>
