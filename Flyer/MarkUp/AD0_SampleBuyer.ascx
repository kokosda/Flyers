<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AD0_SampleBuyer.ascx.cs" Inherits="FlyerMe.Flyer.MarkUp.AD0_SampleBuyer" %>
...
<![endif]--></div>
                ...
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="color:#f37b22;">
                        	<tr>
                            	<td  valign="bottom" style="padding:65px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_1.png" /> <span>MLS:</span> <strong style="color:#000000;">0689335</strong></td>
                           	  <td  valign="bottom" style="padding:65px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_9.png" /> <span>HOA:</span> <strong style="color:#000000;">Village</strong></td>
                            </tr>
                        	<tr>
                            	<td  valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_3.png" /> <span>Bedrooms:</span> <strong style="color:#000000;">2</strong></td>
                            	<td  valign="bottom" style="padding:8px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_6.png" /> <span>Subdivision:</span> <strong style="color:#000000;">Ben Tree Village</strong></td>
                            </tr>
                            <tr>
                            	<td valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_4.png" /> <span>Full Baths:</span> <strong style="color:#000000;">2</strong></td>
                            	<td valign="bottom" style="padding:8px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_7.png" /> <span>Year Built:</span> <strong style="color:#000000;">1986</strong></td>
                            </tr>
                        	<tr>
                            	<td valign="bottom" style="padding:8px 0px 55px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_5.png" /> <span>Lot Size:</span> <strong style="color:#000000;">10466</strong></td>
                            	<td valign="bottom" style="padding:8px 0px 55px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_8.png" /> <span>Sqft:</span> <strong style="color:#000000;">1580</strong></td>
                            </tr>
                        </table>
                        </td>
                </tr>
                <tr>
                	<td align="center">
                    	<table cellpadding="0" cellspacing="0" width="372" style="border:2px solid #f37b22;border-radius:19px; -webkit-border-radius:19px; -moz-border-radius:19px;font-weight:900; color:#000000;">
                            <tr>
                                <td style="padding:10px 0;" align="center">
                                    <img src="<%= EmailImageUrl %>images/icons_orang_2.png" />  Price: $199K - $340K
                                </td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="0" width="100%" style="font-size:15px;  line-height:26px; letter-spacing:0.6px; color:#f37b22; padding:50px 0 0px 0;" >
                        	...
                        	<tr>
                            	<td style="padding:0 0 0 70px;" valign="bottom"><img src="<%= EmailImageUrl %>images/icons_orang_10.png" />Phone: <strong style=" color:#000000;">311-414-1413</strong>
                                </td>
                            	<td valign="bottom"><img src="<%= EmailImageUrl %>images/icons_orang_11.png" />Email: <strong style="color:#000000;">happyha@gmail.com</strong>
                                </td>
                            </tr>
                            </table>
                            </td>
                        	...
                        	<tr>
                                ...
                                <span style="display:block; padding:0 3px 25px 0;float:left;"><img src="<%= EmailImageUrl %>images/icons_orang_12.png" />Location:</span><span style="color:#000000;">Orlando Area, East or South of Downtown in Orange County or Northern Osceola County. Preferrably south of Rt 50.</span>
                                </td>
                            </tr>
                        </table>
                    </td>
