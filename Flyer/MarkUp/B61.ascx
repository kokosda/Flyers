<%@ Control Language="C#" AutoEventWireup="true" CodeFile="B61.ascx.cs" Inherits="FlyerMe.Flyer.MarkUp.B61" %>
...
<![endif]--></div>
                ...
                <tr>
                	<td background="<%= EmailImageUrl %>images/bg_images_04_email.png" bgcolor="#ff7c0c" width="648" height="384" valign="top">
                  <!--[if gte mso 9]>
                  ...
                  <tr>
                   <td style="font-size:36px; text-align:center; padding:55px 0 0 0;"><%= Flyer.FlyerTitle %></td>
                   </tr>
                    <% } %>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="color:#f37b22;">
                        <% if (Flyer.MlsNumber.HasText() || Flyer.Hoa.HasText()) { %>
                        	<tr>
                            	...
                            	<td  valign="bottom" style="padding:65px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_1.png" /> <span>MLS:</span> <strong style="color:#000000;"><%= Flyer.MlsNumber %></strong></td>
                                <% } else { %>
                                <td  valign="bottom" style="padding:65px 0px 8px 63px;" width="48%"></td>
                                <% } %>
                                <% if (Flyer.Hoa.HasText()) { %>
                           	    <td  valign="bottom" style="padding:65px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_9.png" /> <span>HOA:</span> <strong style="color:#000000;"><%= Flyer.Hoa %></strong></td>
                                <% } else { %>
                        ...
                        <% if (Flyer.Bedrooms.HasText() || Flyer.Subdivision.HasText()) { %>
                        	<tr>
                            	...
                            	<td  valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_3.png" /> <span>Bedrooms:</span> <strong style="color:#000000;"><%= Flyer.Bedrooms %></strong></td>
                                <% } else { %>
                                <td  valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"></td>
                                <% } %>
                                <% if (Flyer.Subdivision.HasText()) { %>
                            	<td  valign="bottom" style="padding:8px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_6.png" /> <span>Subdivision:</span> <strong style="color:#000000;"><%= Flyer.Subdivision %></strong></td>
                                <% } else { %>
                        ...
                        <% if (Flyer.Bathrooms.HasText() || Flyer.YearBuilt.HasText()) { %>
                            <tr>
                            	...
                            	<td valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_4.png" /> <span>Full Baths:</span> <strong style="color:#000000;"><%= Flyer.Bathrooms %></strong></td>
                                <% } else { %>
                                <td valign="bottom" style="padding:8px 0px 8px 63px;" width="48%"></td>
                                <% } %>
                                <% if (Flyer.YearBuilt.HasText()) { %>
                            	<td valign="bottom" style="padding:8px 0px 8px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_7.png" /> <span>Year Built:</span> <strong style="color:#000000;"><%= Flyer.YearBuilt %></strong></td>
                                <% } else { %>
                                <td valign="bottom" style="padding:8px 0px 8px 63px;></td>
                                <% } %>
                            </tr>
                        ...
                        <% if (Flyer.LotSize.HasText() || Flyer.Sqft.HasText()) { %>
                        	<tr>
                            	...
                            	<td valign="bottom" style="padding:8px 0px 55px 63px;" width="48%"><img src="<%= EmailImageUrl %>images/icons_orang_5.png" /> <span>Lot Size:</span> <strong style="color:#000000;"><%= Flyer.LotSize %></strong></td>
                                <% } else { %>
                                <td valign="bottom" style="padding:8px 0px 55px 63px;" width="48%"></td>
                                <% } %>
                                <% if (Flyer.Sqft.HasText()) { %>
                            	<td valign="bottom" style="padding:8px 0px 55px 63px;"><img src="<%= EmailImageUrl %>images/icons_orang_8.png" /> <span>Sqft:</span> <strong style="color:#000000;"><%= Flyer.Sqft %></strong></td>
                                <% } else { %>
                ...
                <tr>
                	<td align="center">
                    	...
                    	<table cellpadding="0" cellspacing="0" width="372" style="border:2px solid #f37b22;border-radius:19px; -webkit-border-radius:19px; -moz-border-radius:19px;font-weight:900; color:#000000;">
                            <tr>
                                <td style="padding:10px 0;" align="center">
                                    <img src="<%= EmailImageUrl %>images/icons_orang_2.png" />  Price: <%= PriceRange %>
                                </td>
                            </tr>
                        </table>
                        <% } %>
                        <% if (IsContactsBlockVisible || IsLocationBlockVisible) { %>
                        <table cellpadding="0" cellspacing="0" width="100%" style="font-size:15px;  line-height:26px; letter-spacing:0.6px; color:#f37b22; padding:50px 0 0px 0;" >
                            <% if (IsContactsBlockVisible) { %>
                        	<tr>
                            <td>
                            <table cellpadding="0" cellspacing="0" width="100%" style="font-size:15px;  line-height:26px; letter-spacing:0.6px; color:#f37b22;">
                        	<tr>
                            	<td style="padding:0 0 0 70px;" valign="bottom"><img src="<%= EmailImageUrl %>images/icons_orang_10.png" />Phone: <strong style=" color:#000000;"><%= Phone %></strong>
                                </td>
                            	<td valign="bottom"><img src="<%= EmailImageUrl %>images/icons_orang_11.png" />Email: <strong style="color:#000000;"><a href="mailto:<%= Flyer.Email %>"><%= Flyer.Email %></a></strong>
                                </td>
                            </tr>
                            </table>
                            </td>
                        	...
                        	<tr>
                                ...
                                <span style="display:block; padding:0 3px 25px 0;float:left;"><img src="<%= EmailImageUrl %>images/icons_orang_12.png" />Location:</span><span style="color:#000000;"><%= Flyer.Location.Replace("\n", "<br />") %></span>
                                </td>
                            </tr>
                            <% } %>
                        </table>
                ...
                <tr>
                	<td background="<%= EmailImageUrl %>images/bg_images_04_2_email.png" bgcolor="#09509e" width="648" height="560" valign="top" align="center">
                      <!--[if gte mso 9]>
                      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:648px;height:560px;">
                        <v:fill type="tile" src="<%= EmailImageUrl %>images/bg_images_04_2_email.png" color="#09509e" />
                        <v:textbox inset="0,0,0,0">
                      <![endif]-->
                      <p>&nbsp;</p>
