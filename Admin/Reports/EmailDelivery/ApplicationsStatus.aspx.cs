...
{
    public partial class ApplicationsStatus : AdminPageBase
    {
        ...
        protected void grid_RowHeadBinding(Object sender, RowHeadBindingEventArgs e)
        {
            ...
            e.Grid.Head.HeaderCells.Add(new HeaderCell { Text = "Delivering SMTP" });
        }
        ...
        private void InitGrid()
        {
            ...
            grid.GridDataSource.SqlDataSourceSelectCommand = "usp_GetDeliveryAppStatus";
